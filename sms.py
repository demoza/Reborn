...
8888888888888888888888888'''+Style.RESET_ALL)
		...
		parser = argparse.ArgumentParser(prog='reborn', description="Fucking shit by FSystem88. Возможно что-то уже не работает. Только для России!",epilog='Мой e-mail - FSystem88@bk.ru')
